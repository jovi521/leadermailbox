 ...
 **/
@ApiModel(value = "TWfSendBack", description = "电话工单派单记录")
@Entity
@Table(name = "t_wf_send_back")
@Data
public class TWfSendBack implements Serializable {
    ...
    @Column(length = 50)
    @ApiModelProperty(name = "bDutyTel", value = "回复单位电话")
    private String bDutyTel;
